#ifndef LUAHOOK_CMD_H 
#define LUAHOOK_CMD_H
#pragma once
...
namespace moddingApi
{
	...
	{
	public:
		static void __fastcall ccSetGroupBattleCharPos(float a1, std::string a2, float a3, float a4, float a5, float a6, float a7, float a8);
